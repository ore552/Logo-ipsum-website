...
const SubPlans = () => {
    ...
    const handleHover = () => {
        controls.start({ x: [0, -5, 5, 0], transition: {duration: 0.7} });
    };
  ...
  return (
    ...
    className='top flex justify-between items-end md-[7vh] mt-[4vh]'
    >
    ...
    <div className='bottom'>
        <div className='flex justify-evenly plans flex-warp'>
            {plans.map((plan) => (
                <div
                data-aos="flip-up"
